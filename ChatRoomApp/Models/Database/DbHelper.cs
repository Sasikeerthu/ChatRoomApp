...
namespace ChatRoomApp.Models.Database
{
    public class DbHelper
    {
#if DEBUG
        private static string defaultConnectionString = "Data Source=KSVLAP045;Initial Catalog=ChatRoomApp;Integrated Security=True;TrustServerCertificate=True";
#else
